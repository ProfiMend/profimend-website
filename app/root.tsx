...
export default function App() {
  ...
  <div className="shadow-xl border-t-4 border-blue-500 rounded-2xl p-10 text-center scale-105 transition-transform hover:scale-110 h-72">
    ...
    <div className="shadow-lg border-t-4 border-orange-500 rounded-xl p-6 text-center h-72">
    ...
    <div className="shadow-lg border-t-4 border-blue-400 rounded-xl p-6 text-center h-72">
