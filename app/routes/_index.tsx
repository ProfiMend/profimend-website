  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white text-slate-800">
      ...
      <section className="relative">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-16 pb-14 text-center text-white md:pt-20 md:pb-16">
          <motion.h1
          ...
          >
            <a href="/signup" className="rounded-xl bg-white/95 text-sky-700 px-6 py-3 font-semibold shadow hover:bg-white">
              Get Started Free
            </a>
            <a href="/demo" className="rounded-xl border border-white/70 px-6 py-3 font-semibold text-white hover:bg-white/10">
              Watch demo
            </a>
          </motion.div>
      ...
      {/* FEATURES (well spaced, no overlap) */}
